...
if (typeof document.dev_env != "undefined") {
  ...
  base_url = "https://raw.githubusercontent.com/sirnoe/edpuzzle-answers/main";
}
...
function openPopup(assignment) {
  ...
  <hr>
  <p style="font-size: 12px">Made by: Liqticc (Partially) | Contact me if any issues</p>
  <p style="font-size: 12px">Thanks for Buying!</p>`;
